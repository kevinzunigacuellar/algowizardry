...
3. Iterate through the string.
   1. If the current character is already in the map, move the `left` pointer to the last seen index of the character + 1. If the character is not in the map, add it to the map.
   2. Update the max length of the substring.
