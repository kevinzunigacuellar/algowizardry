...
- **Time Complexity**
  - `push` - `O(1)` - We are pushing the value to the stack in constant time.
  - `pop` - `O(1)` - We are popping the value from the stack in constant time.
  - `top` - `O(1)` - We are returning the top element from the stack in constant time.
  - `getMin` - `O(1)` - We are returning the minimum element from the stack in constant time.